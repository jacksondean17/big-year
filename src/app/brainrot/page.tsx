...
import { BrainrotChallengeList } from "@/components/brainrot-challenge-list";
import { createClient } from "@/lib/supabase/server";

export default async function BrainrotPage() {
    ...
    <div>
      <div className="mb-6">
        <h1
          ...
          style={{
            background: "linear-gradient(90deg, #00ff88, #00ffff, #ff00ff, #ff6600)",
